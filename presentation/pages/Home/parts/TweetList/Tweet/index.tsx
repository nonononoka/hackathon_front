...
export const EachTweet = (props: EachTweetProps) => {
    ...
    const { id, body, postedAt, postedByName, postedBy, postedByImage, likeCount, replyCount, tags, isFaved } = props
    const [tweet, setTweet] = useState({ id, body, postedAt, postedByName, postedBy, postedByImage, likeCount, tags, isFaved, replyCount })
    ...
    useEffect(() => {
        setTweet({ id, body, postedAt, postedByName, postedByImage, postedBy, likeCount, tags, isFaved, replyCount })
    }, [id, body, postedAt, postedByName, postedBy, postedByImage, likeCount, tags, isFaved, replyCount])
